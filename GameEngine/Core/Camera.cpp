...
//when we press key
void Camera::KeyPressed(unsigned char key, int xmouse, int ymouse)
{
	...
	const float speed = 0.07f;//how fast we move
...
void Camera::MouseMove(int x, int y, int width, int height)
{
	...
	const float mouseX_Sensitivity = 0.008f;
	const float mouseY_Sensitivity = 0.008f;
